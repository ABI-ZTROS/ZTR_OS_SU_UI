...
ZTR_OS SU prend officiellement en charge la plupart des noyaux Android de la version 4.4 à la version 6.6.
 - Les noyaux GKI 2.0 (5.10+) peuvent exécuter des images pré-construites et des modules GKI.
...
- [Instructions d'installation](https://ztros.su/pages/installation.html)
...
- [KernelSU](https://github.com/tiann/KernelSU) : Merci à tiann, sans qui ZTR_OS SU n'existerait même pas.
