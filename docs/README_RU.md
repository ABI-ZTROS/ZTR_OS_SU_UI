...
ZTR_OS SU поддерживает ядра Android версий **от 4.4 до 6.6**.

| Версия ядра          | Примечания по поддержке                                                                  |
|----------------------|------------------------------------------------------------------------------------------|
| 5.10+ (GKI 2.0)      | Поддержка предсобранных образов и GKI                                                |
...
> [!CAUTION]
> В последних версиях ядра реализовано критическое изменение, из-за которого ZTR_OS SU перестает работать и может вызвать панику ядра (kernel panic) на `x86_64`! Дополнительную информацию смотрите на сайте!

---

## 📦 Установка

Пожалуйста, ознакомьтесь с [руководством по установке](https://ztros-su.github.io/webpage/pages/installation.html) для получения инструкций по настройке.
...
- [KernelSU](https://github.com/tiann/KernelSU) – Основа для создания ZTR_OS SU
